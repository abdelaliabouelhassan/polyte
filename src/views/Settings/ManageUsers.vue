...
export default {
  ...
  setup() {
    ...
    const Users = ref([
      {
        name: "Siglinde Klos",
        email: "klos@berghain.com",
        company: "Berghain GmbH",
        role: "Artist",
      },
      {
        name: "Marius Wildeke",
        email: "wildeke@berghain.com",
        company: "Berghain GmbH",
        role: "Admin",
      },
      {
        name: "Astrid Ärgerlich",
        email: "aergerlich@berghain.com",
        company: "Berghain GmbH",
        role: "Manager",
      },
    ]);
