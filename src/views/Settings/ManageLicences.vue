                ...
                >
                  ...
                  <tbody class="divide-tertiary-gray divide-y-4">
                    <tr
                      ...
                      v-for="(licence, index, key) in Licences"
                      :key="key"
                    >
                      <td
                        class="
  ...
  setup() {
    ...
    const Licences = ref([
      ...
      },
      {
        ...
        description: "Ideal for large business",
        impressions: "40.000",
        extra_impres: "0.05 €",
        Storage: "1.500 GB",
        user: "5",
      ...
      {
        name: "Custom - CL",
        description: "Coniclabs Internal",
        impressions: "100.000",
        extra_impres: "0 €",
        Storage: "1.500 GB",
        user: "100",
      ...
      {
        name: "Custom - Fabrix",
        description: "Fabrik - Manage Companies",
        impressions: "20.000",
        extra_impres: "0.1 €",
        Storage: "800 GB",
        user: "10",
      ...
      {
        name: "Custom - Adidas",
        description: "Large Scale Impressions",
        impressions: "150.000",
        extra_impres: "0.01 €",
        Storage: "1.500 GB",
        user: "5",
